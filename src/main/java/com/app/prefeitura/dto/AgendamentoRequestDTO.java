...
public class AgendamentoRequestDTO implements Serializable{
    ...
    public AgendamentoRequestDTO(Long id, Secretaria secretaria, Servico tipoServico, LocalDate data, LocalTime hora) {
        this.id = id;
    ...
    public AgendamentoRequestDTO(Agendamento entity) {
