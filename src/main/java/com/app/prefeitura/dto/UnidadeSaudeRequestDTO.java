...
public class UnidadeSaudeRequestDTO implements Serializable {
    ...
    public UnidadeSaudeRequestDTO() {
    }

    public UnidadeSaudeRequestDTO(Long id, String nome, String lougrado, String numero, String complemento, String bairro, String cep, String longitude, String latitude) {
        this.id = id;
        this.nome = nome;
    ...
    public UnidadeSaudeRequestDTO(UnidadeSaude entity) {
